...
-keepclassmembers class com.zss.framaist.bean.** {*;}
-keepclassmembers class com.zss.base.bean.** {*;}
...
# ========== Retrofit Converter 相关 ==========
# 保留 Retrofit 的 Converter 相关类
-keep class retrofit2.converter.gson.** { *; }
-keep class * implements retrofit2.Converter { *; }

# 保留 GsonConverterFactory
...
#    private static native long getMMKVWithID(...);
#    private static native void removeStorage(...);
#}
...
# 主题和资源
-keep class * extends androidx.compose.material3.Typography { *; }
-keep class * extends androidx.compose.material3.ColorScheme { *; }

# 性能注解
-keep @androidx.compose.runtime.Stable class * { *; }
-keep @androidx.compose.runtime.Immutable class * { *; }

# 保护 Compose 相关的 Kotlin 特性
...
# 保留 JsonSerializer 和 JsonDeserializer
-keep class * implements com.google.gson.JsonSerializer { *; }
-keep class * implements com.google.gson.JsonDeserializer { *; }

## 保留构造方法和字段
#-keepclassmembers class com.zss.common.bean.** {
#    public <init>(...);
#    public *;
#    private *;
#}
