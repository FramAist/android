...
# ========== 保护 Dialog 相关类 ==========
-keep class com.zss.common.Dialog.** { *; }
-keepclassmembers class com.zss.common.Dialog.** {
    *;
}
# 保留support下的所有类及其内部类
...
-keep class com.zss.common.databinding.** { *; }
-keepclassmembers class com.zss.common.databinding.** {
    *;
}
